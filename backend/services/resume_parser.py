import io
import magic    #python lib to identify the  file type
from typing import Tuple ,Optional
import pdfplumber     # for parsing pdf
from docx import Document     #for parsing document
import PyPDF2   #just for fallback
...
def _extract_pdf_hyperlinks(file_data: bytes) -> str:      #Just to check ki resume me impotant links h ki nhi bcz generallyy annotation wali layer parse nhi hoti automatically
    urls = []
    try:
